    ...
    const foodCourts = [
        {
            ...
            description: 'A vibrant dining hub offering a variety of delicious cuisines.'
        },
        {
            id: 2,
            name: 'FC (Food Court)',
                ...
                <div className="mb-8">
                    ...
                    {filteredFoodCourts.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredFoodCourts.map((court) => (
                                <motion.div
                                    ...
                                    onClick={() => court.isOpen && handleFoodCourtClick(court)}
                                >
                                    <div className="relative">
                                        <img
                                            src={court.image}
                        ...
                        <div className="text-center py-8">
                            <p className="text-gray-600">No food courts found.</p>
                        </div>
                    )}
                </div>
            </div>
